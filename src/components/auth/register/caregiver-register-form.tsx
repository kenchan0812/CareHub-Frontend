...
import CareGiverRoleForm from "@/components/auth/register/care-giver-role-form";

export const CaregiverRegistrationForm = () => {
  const [error, setError] = useState<string | undefined>("");
  const [isPending, startTransition] = useTransition();
  const [showForm, setShowForm] = useState<boolean>(true);
  const [registerInfo, setRegisterInfo] = useState<
    z.infer<typeof RegisterCustomerSchema>
  >({
    email: "",
    password: "",
    name: "",
  ...
  return showForm ? (
    ...
    <CareGiverRoleForm registerInfo={registerInfo} setShowForm={setShowForm} />
  );
};
